...
export default function RincianLaporanBulananPage() {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      <h1 style={{ margin: "0 0 0.5rem", color: "var(--color_font_main)" }}>Rincian Laporan Bulanan PPAT</h1>
      <p style={{ margin: 0, color: "var(--color_font_muted)", fontSize: "0.9rem", marginBottom: 20 }}>
        Rincian berkas per bulan (status Diserahkan). Data dari <code>/api/ppat/rekap/diserahkan</code>.
      </p>
