...
export default function LSBSidebar() {
      ...
      >
        <div style={{ overflowY: "auto", overflowX: "hidden", flex: 1 }}>
          <div style={{ padding: "2px", cursor: "pointer" }}>
            <Link
              href="/lsb"
              className={menuItemClasses(isActive("/lsb") && pathname === "/lsb")}
            >
              {sidebarExpanded ? (
                <>
                ...
                <span style={radioStyle(isActive("/lsb") && pathname === "/lsb")} />
              )}
            </Link>
          </div>
          ...
          <div
            ...
            onMouseEnter={() => handleDropdownEnter("pelayanan")}
          ...
          >
            <div
              ...
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                handleDropdownToggle("pelayanan");
              }}
              onKeyDown={(e) => e.key === "Enter" && (e.preventDefault(), handleDropdownToggle("pelayanan"))}
              className={menuItemClasses(isActive("/lsb/pelayanan-penyerahan-sspd") || isActive("/lsb/monitoring-penyerahan"))}
            >
              {sidebarExpanded ? (
                <>
                  <span className={styles.iconWrap} style={iconStyle}>
                ...
                <span style={radioStyle(isActive("/lsb/pelayanan-penyerahan-sspd") || isActive("/lsb/monitoring-penyerahan"))} />
              )}
            </div>
            <div className={dropdownContentClasses(openDropdownId === "pelayanan")}>
              <Link
                href="/lsb/pelayanan-penyerahan-sspd"
                className={dropdownLinkClasses(pathname === "/lsb/pelayanan-penyerahan-sspd")}
              >
                Pelayanan Penyerahan SSPD
              </Link>
              <Link
                href="/lsb/monitoring-penyerahan"
                className={dropdownLinkClasses(pathname === "/lsb/monitoring-penyerahan")}
              >
                Monitoring Penyerahan SSPD
              </Link>
            </div>
          </div>
