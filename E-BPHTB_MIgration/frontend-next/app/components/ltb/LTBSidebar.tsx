...
export default function LTBSidebar() {
      ...
      >
        <div style={{ overflowY: "auto", overflowX: "hidden", flex: 1 }}>
          <div style={{ padding: "2px", cursor: "pointer" }}>
            <Link
              href="/ltb"
              className={menuItemClasses(isActive("/ltb") && pathname === "/ltb")}
            >
              {sidebarExpanded ? (
                <>
                ...
                <span style={radioStyle(isActive("/ltb") && pathname === "/ltb")} />
              )}
            </Link>
          </div>
          ...
          <div
            ...
            onMouseEnter={() => handleDropdownEnter("terima")}
          ...
          >
            <div
              ...
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                handleDropdownToggle("terima");
              }}
              onKeyDown={(e) => e.key === "Enter" && (e.preventDefault(), handleDropdownToggle("terima"))}
              className={menuItemClasses(isActive("/ltb/terima-berkas-sspd"))}
            >
              {sidebarExpanded ? (
                <>
                  <span className={styles.iconWrap} style={iconStyle}>
                ...
                <span style={radioStyle(isActive("/ltb/terima-berkas-sspd"))} />
              )}
            </div>
            <div className={dropdownContentClasses(openDropdownId === "terima")}>
              <Link
                href="/ltb/terima-berkas-sspd"
                className={dropdownLinkClasses(pathname === "/ltb/terima-berkas-sspd")}
              >
                Permohonan Validasi SSPD
              </Link>
              <Link
                href="/ltb/penginputan-offline"
                className={dropdownLinkClasses(pathname === "/ltb/penginputan-offline")}
              >
                Penginputan Offline
              </Link>
            </div>
