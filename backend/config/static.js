...
export const staticConfig = (app) => {
    ...
    app.use('/storage/ppatk', express.static(path.join(projectRoot, 'backend', 'storage', 'ppatk')));
    ...
    console.log('📁 [STATIC] - /storage/ppatk ->', path.join(projectRoot, 'backend', 'storage', 'ppatk'));
