...
export default function registerCreateBookingEndpoints({ app, pool, logger }) {
    ...
    // PPAT: Create booking and BPHTB calculation for Perorangan
    app.post('/api/ppat_create-booking-and-bphtb-perorangan', async (req, res) => {
        try {
            console.log('📝 [PPAT-PERORANGAN] Creating booking and BPHTB calculation...');
            ...
            const {
                ...
                noppbb,
                jenis_wajib_pajak = 'Perorangan', // Force to Perorangan
                namawajibpajak,
                alamatwajibpajak,
                ...
                kelurahandesawp,
                rtrwwp,
                npwpwp, // This will be NIK KTP for perorangan
                kodeposwp,
                kabupatenkotaop,
                kecamatanop,
                kelurahandesaop,
                rtrwop,
                npwpop, // This will be NIK KTP for perorangan
                kodeposop,
                trackstatus = 'Draft',
            ...
            console.log('📝 [PPAT-PERORANGAN] Booking data received:', {
                userid,
                noppbb,
                namawajibpajak,
                namapemilikobjekpajak,
            ...
            console.log('📝 [PPAT-PERORANGAN] Letting database trigger generate nobooking for ppat_khusus:', ppat_khusus);
            
            console.log('📝 [PPAT-PERORANGAN] Starting transaction for booking creation...');
            ...
            try {
                ...
                const bookingParams = [
                    'Perorangan', // Force jenis_wajib_pajak to Perorangan
                    userid,
                    noppbb,
                    namawajibpajak,
                    alamatwajibpajak,
                    ...
                    kelurahandesawp,
                    rtrwwp,
                    npwpwp, // NIK KTP for perorangan
                    kodeposwp,
                    kabupatenkotaop,
                    kecamatanop,
                    kelurahandesaop,
                    rtrwop,
                    npwpop, // NIK KTP for perorangan
                    kodeposop,
                    trackstatus
                ];
                ...
                console.log('✅ [PPAT-PERORANGAN] Booking created:', createdNobooking);
                ...
                if (nilaiPerolehanObjekPajakTidakKenaPajak !== undefined) {
                    ...
                    console.log('✅ [PPAT-PERORANGAN] BPHTB perhitungan created:', bphtbResult.rows[0].calculationid);
                }
                ...
                if (letaktanahdanbangunan !== undefined) {
                    ...
                    let normalizedStatusKepemilikan = 'Milik Pribadi';
                    ...
                    console.log('✅ [PPAT-PERORANGAN] Objek pajak created:', objekResult.rows[0].id);
                }
                ...
                if (luas_tanah !== undefined && njop_tanah !== undefined) {
                    ...
                    console.log('✅ [PPAT-PERORANGAN] NJOP perhitungan created:', njopResult.rows[0].id);
                }
                ...
                console.log('✅ [PPAT-PERORANGAN] Sign record created with user signature:', signResult.rows[0].id);
                
                // Commit transaction
                await client.query('COMMIT');
                
                console.log('✅ [PPAT-PERORANGAN] All booking data created successfully:', {
