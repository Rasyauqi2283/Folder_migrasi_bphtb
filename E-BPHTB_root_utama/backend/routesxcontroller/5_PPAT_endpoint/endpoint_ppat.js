...
app.post('/api/ppat/upload-signatures', async (req, res) => {
    try {
        ...
        if (!nobooking) {
            ...
            const uploadDir = path.join(process.cwd(), 'E-BPHTB_root_utama', 'public', 'penting_F_simpan', 'folderttd', 'folderttdwp');
...
app.get('/api/ppat/file-proxy', async (req, res) => {
    try {
        ...
        const fullPath = path.join(process.cwd(), 'E-BPHTB_root_utama', 'backend', 'storage', 'ppat', relativePath);
...
app.get('/api/ppat/railway-health', async (req, res) => {
    try {
        ...
        const fs = await import('fs');
        const path = await import('path');
        const storagePath = path.join(process.cwd(), 'E-BPHTB_root_utama', 'backend', 'storage', 'ppat');
