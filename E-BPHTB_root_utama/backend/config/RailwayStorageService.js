...
const RAILWAY_STORAGE_CONFIG = {
    ...
    publicPath: './E-BPHTB_root_utama/public/signatures',
    ...
    // URL configuration
    baseUrl: process.env.RAILWAY_PUBLIC_DOMAIN || process.env.BASE_URL || process.env.FRONTEND_URL || `http://localhost:${process.env.PORT || 3000}`,
