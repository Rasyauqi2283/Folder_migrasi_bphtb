...
export default function registerGeneratePdfBooking(app, pool) {
    app.get('/api/ppat_generate-pdf-badan/:nobooking', async (req, res) => {
        ...
        try {
            ...
            const logoPath = path.resolve(process.cwd(), 'E-BPHTB_root_utama', 'public', 'asset', 'Logobappenda_pdf.png');
            const pageWidth = 595;
            ...
            try {
                ...
                if (wpSignaturePath) {
                    ...
                    if (wpSignaturePath.startsWith('/')) {
                        ...
                        wpAbs = path.resolve(process.cwd(), 'E-BPHTB_root_utama', 'public', relativePath);
                    } else {
            ...
            try {
                ...
                if (signaturePath) {
                    ...
                    if (signaturePath.startsWith('/')) {
                        ...
                        ppatAbs = path.resolve(process.cwd(), 'E-BPHTB_root_utama', 'public', relativePath);
                        ...
                        if (!fs.existsSync(ppatAbs) && signaturePath.includes('folderttd_ppat')) {
                            ...
                            ppatAbs = path.resolve(process.cwd(), 'E-BPHTB_root_utama', 'public', correctedRelativePath);
