...
document.getElementById('formBadanUsaha_Bphtb').addEventListener('submit', async function(event) {
    ...
    //npwp WP
    //kolom tabel pat_1_bookingsspd (npwpwp)
    ...
    //npwp OP
    //kolom tabel pat_1_bookingsspd (npwpop)
    ...
    const data = {
        ...
        npwpwp: npwpwp, //kolom tabel pat_1_bookingsspd (npwpwp)
        ...
        npwpop: npwpop, //kolom tabel pat_1_bookingsspd (npwpop)
